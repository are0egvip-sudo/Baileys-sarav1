        ...
        sendMessage: async (jid, content, options = {}) => {
          ...
          if (content.audio && content.ptt) {
            ...
            */
                ...
                // ✅ إرسال الملصقات المعلقة من stickerPack
                if (global._pendingStickerPack && global._pendingStickerPack.length) {
                    const pending = global._pendingStickerPack.shift();
                    for (let sticker of pending.stickers) {
                        await this.sendMessage(pending.jid, { sticker: sticker.data });
